...
import 'package:flutter_bantu_kyc_module/src/layers/domain/entities/payment_preference_entity.dart';
...
class RegisteredPaymentMethod extends StatelessWidget {
  ...
  const RegisteredPaymentMethod({required this.paymentPreference, super.key});
      ...
      child: Row(
        children: [
          ...
          const CircleAvatar(
            ...
            child: Icon(Icons.edit_square, size: 20, color: Colors.black),
          ),
        ],
      ),
    );
