...
import 'package:flutter_bantu_kyc_module/src/layers/domain/entities/user_balance_entity.dart';
import 'package:flutter_bantu_kyc_module/src/layers/domain/use_cases/exchange_fiat_to_bzc_use_case.dart';
import 'package:flutter_bantu_kyc_module/src/layers/domain/use_cases/get_bzc_currency_converter_use_case.dart';
...
class LoadBottomSheetModal extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet(
      ...
      builder: (context) =>
          LoadBottomSheetModal._(isAfrican, bzcQuantity, bzcExchangePack),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: BlocBuilder<UserBalanceCubit, AsyncSnapshot<UserBalanceEntity>>(
