            ...
            child: Wrap(
              children: <Widget>[
                ListTile(
                  ...
                  title: Text(
                    LocaleKeys.kyc_module_image_service_choose_camera.tr(),
                  ),
                  onTap: () async {
                ...
                ListTile(
                  ...
                  title: Text(
                    LocaleKeys.kyc_module_image_service_choose_gallery.tr(),
                  ),
                  onTap: () async {
...
extension XFileToImageProviderExtension on XFile {
  Future<ImageProvider> toImageProvider() async {
    if (kIsWeb) {
      return MemoryImage(await readAsBytes());
    } else {
